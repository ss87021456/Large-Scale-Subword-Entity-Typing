# Prepare keyword
echo ""
echo "[STAGE 1/5] Parsing and trimming infrequent labels in given hierarchy tree"
...
python src/label.py
python src/label.py --labels=data/label.json --replace --corpus=data/smaller_preprocessed_sentence_keywords.tsv --thread=10
