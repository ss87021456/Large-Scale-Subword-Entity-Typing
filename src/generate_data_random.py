...
# python ./src/generate_data_random.py --input=./data/smaller_preprocessed_sentence_keywords_labeled.tsv
...
def run(model_dir, input, testing):
    ...
    del X, y
    pkl.dump(y_train, open(model_dir + "training_label_random.pkl", 'wb'))
    pkl.dump(y_test, open(model_dir + "testing_label_random.pkl", 'wb'))
    del y_train, y_test
    ...
    pkl.dump(X_t, open(model_dir + "training_data_random.pkl", 'wb'))
    pkl.dump(X_te, open(model_dir + "testing_data_random.pkl", 'wb'))
    del X_t, X_te
    ...
    pkl.dump(X_m_t, open(model_dir + "training_mention_random.pkl", 'wb'))
    pkl.dump(X_m_te, open(model_dir + "testing_mention_random.pkl", 'wb'))
    del X_m_t, X_m_te
    ...
    # dumping model
    pkl.dump(tokenizer, open(model_dir + "tokenizer_random.pkl", 'wb'))
    pkl.dump(m_tokenizer, open(model_dir + "m_tokenizer_random.pkl", 'wb'))
    pkl.dump(mlb, open(model_dir + "mlb_random.pkl", 'wb'))
