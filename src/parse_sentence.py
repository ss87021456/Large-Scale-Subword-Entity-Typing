...
def parse_sentences(corpus, output=None, thread=None):
    """
    """
    if output is None:
    ...
    # Load corpus
    raw_data = readlines(corpus, begin=1) # skip first line
...
if __name__ == '__main__':
    ...
    parse_sentences(args.corpus, args.output, args.thread)
